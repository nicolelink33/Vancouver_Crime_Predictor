...
Image('../plots/eda/crime_type_distribution.png')
```
...
from IPython.display import Image
Image('../results/knn_k_optimization.png')
```
...
from IPython.display import Image
Image('../results/knn_confusion_matrix.png')
```
...
```{python}
#| label: fig-SVM_opt
#| fig-cap: "Hyperparameter optimization of the C value for linear SVM model."

from IPython.display import Image
Image('../results/figures/svm_final_random_fit.png')
```
