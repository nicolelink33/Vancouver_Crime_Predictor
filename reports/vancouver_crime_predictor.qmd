...
baseline_knn_scores = pd.read_csv("../results/knn_baseline_score.csv").round(2)
...
![Observed counts of the four most frequent crime types in the training dataset.](../results/figures/crime_type_distribution.png){#fig-type_dist width=100%}
...
![Hyperparameter optimization of the k value for k-NN model.](../results/figures/knn_k_optimization.png){#fig-KNN_opt width=100%}
...
![Confusion matrix for best fit k-NN model, showing predicted crime type versus actual crime type.](../results/figures/knn_confusion_matrix.png){#fig-KNN_cm width=100%}
...
![Hyperparameter optimization of the C value for linear SVM model.](../results/figures/svm_final_random_fit.png){#fig-SVM_opt width=100%}
![Confusion matrix for best fit SVM model, showing predicted crime type versus actual crime type.](../results/figures/svm_confusion_matrix.png){#fig-SVM_cm width=100%}
...
![Confusion matrix for best fit logistic regression model, showing predicted crime type versus actual crime type.](../results/figures/logreg_confusion_matrix.png){#fig-LR_cm width=100%}
...
All three models also produced similar F1 scores:
