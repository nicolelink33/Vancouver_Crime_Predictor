...
After hyperparameter optimizaation, the optimal value was found to be k = 85, yielding a final accuracy of 64.2% on the test set. 
The hyperparameter optimization results are shown in @fig-KNN_opt. 
![Hyperparameter optimization of the k value for k-NN model.](../results/figures/knn_k_optimization_plot.png){#fig-KNN_opt width=100%}
...
### SVM
The baseline LinearSVC model with C = 1 achieved 64.2% accuracy. 
Results of the hyperparameter optimization search are shown in @fig-SVM_opt. 
The selected model gave a final accuracy of 64.3%, only slightly higher than the baseline, 
